const scriptURL = "YOUR_GOOGLE_SCRIPT_URL_HERE"; // Replace with Apps Script URL
          ...
          PanchMahals: {
            Kalol: {
              ...
              Krishnadasi: [
               ...
               Nayandas: ["Shantilaldas","MahipalDas","DharmeshDas","Jhondas"],
               Dharmeshdas: ["Ashishdas","ManojDas","NayanDas","Arvind Das"]
            },
            Godhra: {
              Babudas: [
            ...
            Halol: {
               Deepakdas: ["Kanudas","Bhagwandas","Arjundas","Jaydas","Rajudas"],
               Jaydas: ["Maheshdas","Sahdevdas","Jagadishdas","Deepak Das"]
            },    
            MorvaHadaf: {
               Nileshdas: ["Balwantdas","Chandudas","fatehsinghdas","Sahdevdas","Dharmeshdas","Rameshdas"],
               Balvantdas: ["Nileshdas","Kanudas","Vinudas","Babudas","Kadudas","Purushottamdas"]
            }, 
            Ghoghamba: {
                Bharatdas: ["Ishwardas","AshokDas","Arvinddas","Girishdas","Sanjaydas","Bharatdas"]
            },  
            Shahera: {
               Nileshdas: ["Hasmukhdas","Pruthvidas","BhalasihDas","RameshDas","ShankarDas","Natudas","Mithadas","MangaDas","Rajesh Das","Pankajdas","Nileshdas","Laldas"],
               Hsamukhdas : ["chandudas","AlpeshDas","MotiDas","Rajudas","Artadas","Arvatadas","Arvind Das","Kirandas","Tinadas","Bhalladas","Fuladas"]
            }, 
            Jambughoda: {}
          },
...
function saveToGoogleSheet(datetime,c,s,d,th,team,m,remark,regular,social) {
  fetch(scriptURL, {
    method: 'POST',
    body: JSON.stringify({ datetime,country:c,state:s,district:d,tahesil:th,team,teammember:m,remark,regular,social })
  })
  .then(res => res.text())
